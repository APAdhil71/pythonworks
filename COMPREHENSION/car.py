...
red_vehicles=[v.get("name") for v in vehicles if v.get("color")=="Red"]
print(red_vehicles)
vehicle_model=[v.get("name") for v in vehicles if v.get("model")==2022]
print(vehicle_model)
diesel_model=[v.get("name") for v in vehicles if v.get("fuel_type")=="Diesel"]
print(diesel_model)
